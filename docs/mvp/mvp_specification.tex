...
\bottomrule
\end{tabular}
\caption{Results on \texttt{config/mvp.yaml} (10 seeds, 450 timesteps each). TS and $\epsilon$-greedy outperform random despite Reactance effect. TS shows the highest mean and lowest variance among learning agents.}
\end{table}
