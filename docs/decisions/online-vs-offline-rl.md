---
title: "Decision Tree: Online vs Offline RL Framing for rl-health-interventions"
status: "active"
...
The existence of this document (`docs/decisions/online-vs-offline-rl.md`)
...
In `docs/archive/plans/subphase_1d_agent_library.md`, the stretch goals list currently
