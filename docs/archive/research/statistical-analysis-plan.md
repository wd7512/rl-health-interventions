...
related: "docs/decisions/initial_design.tex · docs/overview/ROADMAP.md M-08 · docs/decisions/* docs/archive/research/*"
---
...
- The framework's standard metric schema (`metric, value, CI_low,
  ...
  `docs/archive/plans/`. This plan proposes it; the spec doc should adopt
  it explicitly.
