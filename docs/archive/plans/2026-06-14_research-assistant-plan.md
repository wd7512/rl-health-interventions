...
3. No changes to `docs/decisions/initial_design.tex` (awaiting Swapnil's sign-off on the MDP).
4. No changes to `docs/overview/ROADMAP.md` (already merged, signed off in effect via #84).
...
- Decision-tree reports follow the schema in `docs/archive/research/decision-trees/_template.md` (to be created in chunk 1).
...
**Artefact:** `docs/archive/research/simulator-validation.md`
**Decision axes:**
...
**Artefact:** `docs/decisions/online-vs-offline-rl.md`
