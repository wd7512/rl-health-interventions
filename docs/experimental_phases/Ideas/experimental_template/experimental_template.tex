...
Extends the MVP simulator (\texttt{docs/experiments/mvp/mvp\_specification.tex}) by enriching
the state space, action space, and reward function, moving toward the full
MDP defined in \texttt{docs/decisions/initial\_design.tex}.

\section{State Space Extension}
\label{sec:state}

References \texttt{docs/decisions/initial\_design.tex \S3} and Issue \#124.
...
References \texttt{docs/decisions/initial\_design.tex \S3} and Issue \#126.
...
References \texttt{docs/decisions/initial\_design.tex \S3} and Issue \#132.
