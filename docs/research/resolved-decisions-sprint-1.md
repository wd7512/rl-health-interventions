...
| 2026-07-03 | Within-day prompts: bin labels replace midpoint numbers for self-narrative consistency (Jiang et al. 2024, Lu et al. 2025); natural per-action sentences with idle omission (Alomana et al. 2026). See `llm-prompting.md §Prompt-Scorecard` for rationale. |
