---
title: "Technical Dependencies, Risk Register, TRL, and Stub Tracker"
status: "active"
...
Sources: `docs/decisions/initial_design.tex`, `docs/overview/ROADMAP.md`, `reports/phase1_design_analysis.md`, `src/` sources, `config/` sources, `pyproject.toml`
