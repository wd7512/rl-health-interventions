...
_CONFIGS = ["pearl_random"]


@pytest.fixture(scope="module")
def pearl_results() -> dict[str, dict]:
    """Run the pearl_random benchmark once and return all config results."""
...
def test_pearl_random_regression(
    ...
    live_agents = pearl_results.get(config_name, {})
